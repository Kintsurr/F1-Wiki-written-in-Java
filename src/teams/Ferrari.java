...
public class Ferrari extends Team implements topTeams{
    public Ferrari(){
        super( Engines.FERRARI, "Ferrari", "Charles Leclerc", "Carlos Sainz",140000000, 544);
        displayInfo();
        pointsEarned();
    }
    ...
    @Override
    public void top3(){
        System.out.println("Team ended season on third place");
    }
