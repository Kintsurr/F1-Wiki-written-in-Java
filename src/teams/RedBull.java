...
public class RedBull extends Team implements topTeams{

    public RedBull(){
        super( Engines.RED_BULL, "Red Bull", "Max Verstappen", "Sergio Perez", 147000000, 759);
        displayInfo();
        pointsEarned();
    }
    ...
    @Override
    public void top3(){
        System.out.println("Team ended season on first place");
    }
